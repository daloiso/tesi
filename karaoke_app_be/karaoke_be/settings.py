"""
Django settings for karaoke_be project.
...
SECRET_KEY = 'django-insecure-n+la^b$f@p&&#3+x3xz*-$*hj$rcz762s+=qg+b0y-fvd)5mta'
...
WSGI_APPLICATION = 'karaoke_be.wsgi.application'
...
AUTH_USER_MODEL='karaokeapi.UserProfile'
